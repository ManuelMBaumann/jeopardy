...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Di. Mai 29 12:36:41 2018
# Project:  jeopardy.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile jeopardy.pro
#############################################################################
...
moc_jeopardy.cpp: gamefield.h \
		...
		doublejeopardy.h \
		jeopardy.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) jeopardy.h -o moc_jeopardy.cpp
...
moc_gamefield.cpp: editor.h \
		...
		doublejeopardy.h \
		gamefield.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) gamefield.h -o moc_gamefield.cpp

moc_answer.cpp: doublejeopardy.h \
		player.h \
		answer.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) answer.h -o moc_answer.cpp

moc_editor.cpp: player.h \
		editor.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) editor.h -o moc_editor.cpp

moc_podium.cpp: player.h \
		podium.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) podium.h -o moc_podium.cpp

moc_doublejeopardy.cpp: player.h \
		doublejeopardy.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) doublejeopardy.h -o moc_doublejeopardy.cpp
...
ui_answer.h: answer.ui
	/usr/lib/x86_64-linux-gnu/qt4/bin/uic answer.ui -o ui_answer.h
